...
loto_url_base_0001_0460 = 'https://www.mizuhobank.co.jp/retail/takarakuji/check/loto/backnumber/loto6'  # 1～460回目
loto_url_base_0461_1530 = 'https://www.mizuhobank.co.jp/retail/takarakuji/check/loto/backnumber/detail.html?fromto='  # 461回目以降
...
while num <= num_to:
    ...
    if num < 461:
        url = loto_url_base_0001_0460 + str(num).zfill(4) + '.html'
    # 461回目以降当選ページのURL
    else:
        url = loto_url_base_0461_1530 + \
            str(num) + '_' + str(num+19) + '&type=loto6'
